...
def main():
    ...
    while ch == 'y' or ch == 'Y':
        ...
        if user_input == '1':
            ...
            detect_face_realtime(user_db, FRmodel, threshold=threshold)

        elif user_input == '2':
            os.system('cls' if os.name == 'nt' else 'clear')
            # we can use the webcam to capture the user image then get it recognized
            do_face_recognition(user_db, FRmodel, threshold=threshold, save_loc="saved_image/1.jpg")
